...
@section('content')
	...
	<section class="content-page  bg-white">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 bg-one">
                    <div class="container pt-5 pb-5">
                        <div class="row justify-content-end">
                            <div class="col-md-6 pr-5">
                                <img src="{{ asset('assets/img/formandos/5/5.png') }}" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-7 bg-white">
                    <div class="container pt-5 pb-5 h-100">
                        <div class="row h-100 justify-content-start align-items-center">
                            <div class="col-md-9 align-items-center pl-5">
                                <div class="content-text">
                                    <h1 class="text-red pb-5">Diego Rodrigues Veríssimo</h1>
