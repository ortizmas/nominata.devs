...
@section('content')
    ...
    {{-- <section id="formandos">
        ...
        <div class="container pb-5">
            <div class="row  js-filter-grid isotope">
                @foreach ($trainees as $trainee)
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 pb-3 js-filter-item js-filter-grid-item {{ $trainee->association->union->slug }} {{ $trainee->association->slug }} {{ $trainee->slug }}" data-category="{{ $trainee->slug }}">
