...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Formando</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-body register-card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group mb-3 col-md-6">
                                        <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone', $trainee->phone) }}" placeholder="Nome completo" required autofocus> 
                                        @if ($errors->has('phone'))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" name="image_men" class="custom-file-input {{ $errors->has('image_men') ? ' is-invalid' : ''}}" id="customFile" lang="pt-BR">
                                        <label class="custom-file-label" for="customFile">{{ old('image_men', $trainee->image_men) }}</label>
                                    </div>
                                ...
                                <div class="input-group mb-3">
                                    <textarea id="content_men" name="content" class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" placeholder="Conteudo do post" rows="10">{{ old('content', $trainee->content) }}</textarea>
                                ...
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" name="image_woman" class="custom-file-input {{ $errors->has('image_woman') ? ' is-invalid' : ''}}" id="customFile" lang="pt-BR">
                                        <label class="custom-file-label" for="customFile">{{ old('image_woman', $trainee->image_woman) }}</label>
                                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body register-card-body">
                                ...
                                <div class="input-group mb-3">
                                    <select id="CourseId" name="association_id" class="form-control{{ $errors->has('association_id') ? ' is-invalid' : '' }}">
                                        <option value="">Associação</option>
                                        @foreach ($associations as $value)
                                            <option value="{{ $value->id }}" {{ old('association_id', $trainee->association_id)== $value->id ? 'selected' : ''  }}>{{ $value->initials }}</option>
                                        @endforeach
                                    </select>
