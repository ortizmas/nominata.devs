...
@section('content')
    ...
    <section class="content">
      	<div class="container-fluid">
            <form action="{{ route('unions.store') }}" method="post" novalidate="">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group mb-3">
                                    <input id="slug" type="text" class="basic-usage form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}" name="slug" value="{{ old('slug') }}" placeholder="UNIVERSIDADE" required autofocus> 
                                    @if ($errors->has('slug'))
                                        <span class="invalid-feedback" role="alert">
